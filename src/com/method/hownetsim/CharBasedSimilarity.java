 ...
 * 字面相似度计算方法
 *
 * @author <a href="mailto:iamxiatian@gmail.com">夏天</a> @organization
 * 中国人民大学信息资源管理学院 知识工程实验室
 */
public class CharBasedSimilarity implements Similaritable {
    ...
    public static void main(String argsString[])
    {
        String st1="你好";
         String st2="你好厉害";
         CharBasedSimilarity cbs=new CharBasedSimilarity();
       System.out.println( cbs.getSimilarity(st1,st2));
    }
}
